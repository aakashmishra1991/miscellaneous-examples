/*
 * package com.javatpoint; import java.util.ArrayList; import java.util.List;
 * import org.springframework.stereotype.Service;
 * 
 * @Service public class ProductService implements IProductService {
 * 
 * @Override public List<Product> findAll() { //creating an object of ArrayList
 * ArrayList<Product> products = new ArrayList<Product>(); //adding products to
 * the List products.add(new Product(100, "Mobile", "CLK98123", 9000.00, 6));
 ...
 * //returns a list of product return products; } }
 */